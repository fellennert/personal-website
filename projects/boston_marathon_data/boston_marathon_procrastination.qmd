...
This post is the long write-up (scraping, cleaning, matching). If you mainly want **tabbed charts, hoverable Plotly figures, and summary value boxes** on the same dataset, open the companion **[Boston Marathon dashboard](boston_marathon_dashboard.qmd)**.
:::
